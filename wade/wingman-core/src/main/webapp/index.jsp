...
<html>
    ...
    <body class="body horizontal vertical">
      <div class="header">
        ...
        <h1 class = "text-line">Find your next non-alcoholic beverage</h1>
        ...
        <button type="button" class="btn btn-primary drink-btn" aria-label="Left Align" id="all-carbonated-drinks">
            <svg xmlns="http://www.w3.org/2000/svg" width="4vh" height="4vh" fill="currentColor" class="bi bi-cup" viewBox="0 0 36 36">
